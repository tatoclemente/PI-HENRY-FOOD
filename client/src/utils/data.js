export const recipes = [
  {
    id: "584cc8c1-6c87-49e3-8b4f-b7117a113c19",
    name: "Locro",
    image:
      "https://tse2.mm.bing.net/th?id=OIP.NYRiGqnt0UJHagAm32KzNgHaE9&pid=Api&P=0&h=180",
    summary:
      "sadkdhnkjhdfjkjnsb.ksjkksfsfkdsfdjdsdfkdbkdbjdbjdbjdfjdfdfdfdffffffdfdfrv jdkwdidf ñidwhiebeibfhfe hGjbjkdbifioebi luibwubduivfbuievef vavgdjdndgegejkd nsnjdhfdjfkdfkld nbdvhjevfjsvludvuidf kjlsdbjkb",
    healthScore: 100,
    steps: [
      {
        number: 1,
        step: "hervir las carnes",
      },
      {
        number: 2,
        step: "lavar y picar verduras",
      },
      {
        number: 3,
        step: "cocinar",
